...
const utils = require('./shared/untyped.b5d68f89.cjs');
require('scule');
    ...
    visitor: {
      VariableDeclaration(p) {
        ...
        if (t__namespace.isIdentifier(declaration.id) && (t__namespace.isFunctionExpression(declaration.init) || t__namespace.isArrowFunctionExpression(declaration.init))) {
          const newDeclaration = t__namespace.functionDeclaration(declaration.id, declaration.init.params, declaration.init.body);
      ...
      FunctionDeclaration(p) {
        ...
        p.node.params.forEach((param, index) => {
          ...
          if (lparam.typeAnnotation) {
            Object.assign(arg, utils.mergedTypes(arg, inferAnnotationType(lparam.typeAnnotation, getCode)));
          }
          if (param.type === "AssignmentPattern") {
            Object.assign(arg, utils.mergedTypes(arg, inferArgType(param.right)));
          }
