  ...
  return new Promise((resolve, reject) => {
    ...
    if (!tezPages.isExits(url)) {
      import(
        /* @vite-ignore */
        getPreScriptUrl(url)
      ).then((t) => t.default).then(registerData(resolve));
    } else
      resolve(true);
  });
}
...
const IMAGE_DATA_STRING = {};
const IMAGE_STATE = {};
let REQUEST_COUNT = 0;
let imageRequestBroadcaster = void 0;
...
function overrideImageSourceProp() {
  Object.defineProperty(Image.prototype, "src", {
    set(src) {
      if (window.location.hostname.indexOf("localhost") !== -1) {
        js.idleCallback(() => this.setAttribute("src", src), { timeout: 0 });
