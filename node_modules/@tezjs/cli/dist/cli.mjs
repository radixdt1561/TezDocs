import { getPath, commonContainer } from '@tezjs/common';
import mri from 'mri';
...
async function runCommand() {
  ...
  commonContainer.buildOptions = { mode: args.mode === "dev" ? "" : args.mode, rootDir: rootPath, port: args.port || 3e3, commandName };
