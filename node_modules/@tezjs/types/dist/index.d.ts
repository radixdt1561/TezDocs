...
interface CustomPayloadGenratorConfig {
    routePath: string;
}
...
export { BuildOptions, DataSanitizer, Head, HtmlPage, Page, PageCollectionConfig, PageRouteResponse, PaginationConfig, PayloadConfig, RobotsConfig, Route, Sitemap, StrapiModuleConfig, TezConfig, TezSeo, UserCredential };
